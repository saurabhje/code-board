    ...
    <div className="p-10 w-full">
      <form className={`${styles.form}`}>
        ...
        <div className="w-full flex flex-col mt-4">
          ...
          <input id="title" type="text" className="bg-btn-background px-2 py-1 focus:outline-none focus:border-white" />
        </div>
        <div className="w-full flex flex-col mt-4">
          <label htmlFor="snippet">
            Your code
          </label>
          <textarea id="snippet" className="bg-btn-background px-2 py-1 focus:outline-none focus:border-white" rows={8} />
        </div>
